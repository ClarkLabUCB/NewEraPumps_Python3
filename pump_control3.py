...
class PumpControl(QWidget):
    ...
    def initUI(self):      
        ...
        self.ser = serial.Serial(serial_port,19200,timeout=0.2)
    ...
    def run_update(self):
        ...
        for pump in self.rates:
            ...
            if str(self.rates[pump].text()).strip()[1:].isdigit(): #kinda a hack to allow negative numbers, KJ 4/2/21
